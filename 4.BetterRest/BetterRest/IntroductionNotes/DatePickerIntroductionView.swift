...
/* Weitere Notizen zu Date
 ...
 let now = Date.now
 let tomorrow = Date.now.addingTimeInterval(86400)   86400 = Sekunden eines Tages
 let range = now...tomorrow
 
 
 
 Date von einzelnen Komponenten erstellen(Beispiel 8 Uhr Morgens)
 ...
 In dem Fall werden nur die Daten angefragt, ob jetzt day/month/year oder moth/day/year wird
 automatisch je nach User Preferences (also Location) dargestellt
