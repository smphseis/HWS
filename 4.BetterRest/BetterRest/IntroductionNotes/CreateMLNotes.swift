...
/* Notes zu CreateML
 ...
 - CoreML ermöglicht das Einbauen von ML Funktionen in eine App
    - ermölicht eine Vielzahl von Trainingsarten, u.a. Bilderkennung, Geräuscherkennung oder Bewegunserkennung
 - CreateML ermöglicht das Erzeugen eigener Modelle durch einfaches Drag+Drop
