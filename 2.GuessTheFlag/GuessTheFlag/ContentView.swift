...
struct ContentView: View {
    ...
    @State private var scoreDecreased = 0
    @State private var scoreIncreased = 0
    ...
    var body: some View {
        ...
        .sensoryFeedback(.error, trigger: scoreDecreased)
        .sensoryFeedback(.success, trigger: scoreIncreased)
    }
